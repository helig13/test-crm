                            ...
                            <form wire:submit.prevent="update">
                                <div class="mb-4">
                                    <label for="first_name"
                                           class="block text-gray-700 text-sm font-bold mb-2">{{__('First Name')}}
                                        :</label>
                                    <input wire:model="first_name" id="name" type="text"
                                ...
                                <div class="mb-4">
                                    <label for="last_name"
                                           class="block text-gray-700 text-sm font-bold mb-2">{{__('Last Name')}}
                                        :</label>
                                ...
                                <div class="mb-4">
                                    <label for="company_id"
                                           class="block text-gray-700 text-sm font-bold mb-2">{{ __('Company') }}
                                        :</label>
                                    <select wire:model="company_id" id="company_id"
                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                        <option value="company_id">{{ __('Select Company') }}</option>
